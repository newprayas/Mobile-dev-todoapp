  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // Card with stacked progress track behind content
        LayoutBuilder(
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: isActive
                    ...
                    : (isOverdue
                          ? Border.all(color: AppColors.priorityHigh, width: 2)
                          : null),
                boxShadow: isActive
                    ? [
                        BoxShadow(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  // Animated filled portion; allow overflow when overdue
                  Positioned.fill(
                    child: Align(
                      alignment: Alignment.centerLeft,
                      child: OverflowBox(
                  ...
                  // Foreground content (title, chips, icons)
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Title
                      ...
                      // Bottom row: duration chip on left, actions on right
                      Row(
                        children: [
                          GestureDetector(
                            onTap: () async {
                          ...
                          IconButton(
                            ...
                            color: AppColors.lightGray,
                            onPressed: () async {
                              print('Toggle tapped for ${todo.id}');
                              await onToggle();
                            },
                          ...
                          IconButton(
                            ...
                            color: AppColors.lightGray,
                            onPressed: () async {
                              print('Delete tapped for ${todo.id}');
                              await onDelete();
                            },
                            tooltip: 'Delete',
                          ),
