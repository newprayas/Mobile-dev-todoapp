    ...
    try {
      if (Platform.isAndroid) {
        ...
        if (androidImpl != null) {
          final bool? enabled = await androidImpl.areNotificationsEnabled();
            if (enabled == false) {
              ...
              debugLog('NotificationPermissions', 'Requested Android permission granted=$granted');
            } else {
              debugLog('NotificationPermissions', 'Android notifications already enabled');
            }
        }
        ...
        if (iosImpl != null) {
          ...
          debugLog('NotificationPermissions', 'iOS permission granted=$granted');
        }
        ...
        if (macImpl != null) {
          ...
          debugLog('NotificationPermissions', 'macOS permission granted=$granted');
        }
      }
    } catch (e) {
      debugLog('NotificationPermissions', 'Error requesting permissions err=$e');
    }
  }
}
