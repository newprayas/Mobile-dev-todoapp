  ...
  Future<void> showPersistentTimerNotification({
    ...
    androidPlatformChannelSpecifics = AndroidNotificationDetails(
      ...
      styleInformation: BigTextStyleInformation(
        body, // Use body as the collapsed content
        contentTitle: title, // Main title
        summaryText: subText, // Summary text below content
        htmlFormatContent: true, // Allow HTML formatting if desired
        htmlFormatContentTitle: true,
      ),
      actions: <AndroidNotificationAction>[action],
      // This is crucial: tapping the notification body will open the app.
      // Use the same payload as the general notification to ensure `onNotificationTap` knows
      // to open the app.
